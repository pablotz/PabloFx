 ...
 * @author LiveGrios
 */
public class TaskSalaDelete extends Task<Void>
{
    PanelSala panelSala;
    WindowMain app;
    ...
    public TaskSalaDelete(WindowMain app, PanelSala PanelSala, Sala sala)
    {
        this.app = app;
    ...
    {        
        String params = "idProducto=" + sala.getIdSala();
