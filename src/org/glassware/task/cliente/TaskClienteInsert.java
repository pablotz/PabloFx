 ...
 * @author LiveGrios
 */
public class TaskClienteInsert extends Task<Void> {
    ...
    public TaskClienteInsert(WindowMain app,
            PanelCliente panelCliente,
            Cliente cliente) {
        this.app = app;
    ...
    private void save() throws Exception {
        ...
        String server = MySPACommons.URL_SERVER + "/api/Cliente/insert?";
    ...
    private String buildPOSTParams() throws Exception {
        String params = "nombre=" + URLEncoder.encode(cliente.getPersona().getNombre(), "UTF-8")
