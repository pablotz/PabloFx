 ...
 * @author LiveGrios
 */
public class TaskClienteGetAll extends Task<Void> {
    ...
    public TaskClienteGetAll(WindowMain app, PanelCliente panelCliente) {
        this.app = app;
     ...
     * List<Cliente> de Java.
     *
     * @throws Exception
     */
    private void getAll() throws Exception {
        // Establecemos la ruta del servicio REST:
        String server = MySPACommons.URL_SERVER + "/api/Cliente/mostrar";
        ...
        if (responseCode == HttpURLConnection.HTTP_OK) {
            ...
            cliente = parseCliente(responseContent);
            ...
            // una excepción:
            Platform.runLater(() -> {
                panelCliente.getTblvClientes().setItems(FXCollections.observableArrayList(cliente));
            });
        ...
        // de JavaFX:            
        {
            ...
            Platform.runLater(() -> {
                app.showAlert("Error al consultar catálogo de Clientes.",
     ...
     * tipo ArrayList<Cliente>.
     *
     * @param strJson
     * @return
     * @throws Exception
     */
    private List<Cliente> parseCliente(String strJson) throws Exception {
        ...
        cliente = gson.fromJson(strJson, listType);
